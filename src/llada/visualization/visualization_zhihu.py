...
def main(target_step: int = 64):
    ...
    step_size = args.num_steps // 4
    example_steps = [i*step_size for i in range(5)]
    example_steps[-1] = example_steps[-1] - 1
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--num_steps", default=64, type=int)
    arg_parser.add_argument("--num_tokens", default=512, type=int)
